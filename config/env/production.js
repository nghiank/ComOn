module.exports = {
    ...
    db: "mongodb://akaash.gupta@autodesk.com:Iceman123@lennon.mongohq.com:10025/app23651433",
    app: {
        name: "Autodesk - ACE ComOn Production"
    },
    oauth: {
        requestTokenURL: 'https://accounts.autodesk.com/OAuth/RequestToken',
        accessTokenURL: 'https://accounts.autodesk.com/OAuth/AccessToken',
        ...
        apiURL: 'https://accounts.autodesk.com'
    }
}